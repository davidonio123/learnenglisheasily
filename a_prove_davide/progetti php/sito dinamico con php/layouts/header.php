  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if(TITLE == "Chi sono") echo "active" ?>" href="chi-sono.php">Chi sono</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if(TITLE == "Feedback") echo "active" ?>" href=" <?php if(session_status()==1) session_start(); if(isset($_SESSION['id'])) echo "feedback.php?id=" . $_SESSION['id']; else echo "feedback.php"; ?> ">Feedback</a>
        </li>
        <li class="nav-item">
        ...
        if(isset($_SESSION['id'])){
          ?>
            <li class="nav-item">
          <a class="nav-link <?php if(TITLE == "Welcome") echo "active" ?>" href="welcome.php">Welcome</a>
        </li>
          <?php
        }else{
          ?>
